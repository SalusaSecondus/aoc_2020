...
impl TreeMap {
    fn parse(file_name: &str) -> TreeMap {
    ...
    fn get_plant(&self, x: usize, y: usize) -> &char {
        ...
        self.trees.get(&(x % self.width, y)).unwrap()
    }
...
mod tests {
    ...
    #[test]
    fn day3_smoke() {
        let map = TreeMap::parse("day3_smoke.txt");
    ...
    #[test]
    fn day3_1() {
        let map = TreeMap::parse("day3.txt");
